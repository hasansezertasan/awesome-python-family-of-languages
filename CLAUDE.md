...
This is an "awesome list" repository that curates and ranks open-source projects related to the Python family of languages (supersets, subsets, and implementations in other languages). It uses the [best-of-generator](https://github.com/best-of-lists/best-of-generator) to automatically generate a ranked README from project metadata.
...
- `github_id` - Format: `owner/repo` (e.g., `cython/cython`)
